...
export class RoomApi {
    ...
    //             const SQL    = "SELECT DISTINCT COUNT(bidwars101.Bids.item_id) as bids " +
    //                 "FROM bidwars101.Auction_Rooms " +
    //                 "INNER JOIN bidwars101.Bids ON bidwars101.Bids.item_id=bidwars101.Auction_Rooms.item_id " +
    //                 `WHERE auction_date = '${app.getTodaysDate()}' ` +
    //                 `AND room_id = '${roomId}' ` +
    ...
    //             const SQL    = "SELECT DISTINCT bidwars101.Auction_Rooms.item_id, image_blob " +
    //                 "FROM bidwars101.Auction_Rooms " +
    //                 "INNER JOIN bidwars101.Item_Images ON bidwars101.Item_Images.item_id=bidwars101.Auction_Rooms.item_id " +
    //                 `WHERE bidwars101.Auction_Rooms.room_id = ${roomId} ` +
